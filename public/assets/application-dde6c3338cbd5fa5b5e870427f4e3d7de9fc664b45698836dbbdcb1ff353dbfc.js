...
(function() {
  $(function() {
    return $("window").on("click", ".pagination a", function() {
      $.getScript(this.href);
      return false;
    });
  });
...
(function() {
  $(document).on('turbolinks:load', function() {
    $('body').on('keyup', '.searchable-field', function() {
      return $.ajax({
        type: 'GET',
        url: 'questions',
        data: {
...
(function() {
  $(document).on('turbolinks:load', function() {
    return $("#check_all").change(function() {
      var checkBox, checkBoxes, i, len;
